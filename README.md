...
you can access the SVG generation API by making a GET request to the root URL with the package_name query parameter. 

Example - "http://localhost:5000/?package_name=matplotlib"
